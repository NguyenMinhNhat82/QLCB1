        ...
        if ero_msg != '':
            ...
            try:
                ...
                for i in range(len(san_bay_trung_gian_list)):
                    query = san_bay_trung_gian.insert().values(lich_chuyen_bay_id=l.id, san_bay=san_bay_trung_gian_list[i],
                ...
                return redirect('/')
    return render_template('AddFlightSchedule.html',chuyen_bay = chuyen_bay,may_bay =may_bay,san_bay =san_bay,now =now,ero_msg = ero_msg)
...
def details(lich_chuyen_bay_id):
    ...
    return render_template('details.html', lich_chuyen_bay=lcb, chuyen_bay=cb, may_bay=mb, san_bay=sb, san_bay_trung_gian=sbtg,dao =dao)
...
def addinformation(lich_chuyen_bay_id,sove):
    ...
    return render_template("cus_information.html",sove=int(sove),chuyen_bay_id=lich_chuyen_bay_id,cb = cb,lich_chuyen_bay= lich_chuyen_bay)
...
def cus(chuyen_bay_id):
    ...
    return render_template("cus_information.html",sove = int(sove),cb = cb,chuyen_bay_id = chuyen_bay_id,lich_chuyen_bay = lich_chuyen_bay,tongtien = tongtien)
