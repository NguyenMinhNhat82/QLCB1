...
if __name__ == '__main__':
    with app.app_context():
        ...
        # # db.create_all()
        # db.session.commit()
        # m = MayBay(loai_may_bay = 'AIRBUS A330')
        # n = MayBay(loai_may_bay='AIRBUSA350')
        # e = MayBay(loai_may_bay = 'BOEING787')
        ...
        # u = User(name='Vang', username='admin', password=password,
        #          user_role=UserRole.STAFF,
        #          avatar='https://res.cloudinary.com/dexbjwfjg/image/upload/v1669301681/NH_M_27_AIRLINE_free-file_ovn2ao.png')
        # db.session.add(u)
        # db.session.commit()
